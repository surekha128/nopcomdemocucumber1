...
public class BasePage {
        ...
        private static final Logger log = LogManager.getLogger(com.nopcommerce.demo.basepage.BasePage.class.getName());

        public BasePage() {
            PageFactory.initElements(driver,this);
            PropertyConfigurator.configure(projectPath + "/src/test/java/com/nopcommerce/demo/resources/propertiesfile/log4j.properties");
        }
